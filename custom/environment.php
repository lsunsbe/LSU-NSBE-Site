<?
	...
	$bigtree["config"]["www_root"] = "http://localhost/site/index.php/"; // "www_root" should be http://www.website.com/location/of/the/site/
	...
	$bigtree["config"]["admin_root"] = "http://localhost/site/index.php/admin/"; // "admin_root" should be the location you want to access BigTree's admin from, i.e. http://www.website.com/admin/
	...
	$bigtree["config"]["db"]["name"] = "BigTreeCMS";
	$bigtree["config"]["db"]["user"] = "root";
	$bigtree["config"]["db"]["password"] = "cabrini93";
