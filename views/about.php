...
<head>
    ...
    <?php include("components/navmenu.php");
        ...
        <div id="menucol">
            <div id="who" class="active purposebutton"><p>History</p></div>
            <div class="purposebutton" id="what"><p>What We Do</p></div>
            <div class="purposebutton" id="mission"><p>Our Mission</p></div>
        </div>
        <div id="description">
            <div class="active" id="who">
                <h3>History</h3>
