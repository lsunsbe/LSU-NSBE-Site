...
<head>
    ...
    <div id="menu">
	   <?php include("navmenu.php"); echo writenav("photos"); ?>
            ...
            <p>This page is still under construction. In the mean time, you can check out our Instagram <a href="https://www.instagram.com/nsbe_lsu" target="_blank">@NSBE_LSU</a></p>
        </div>
    </div>
    </body>
</html>