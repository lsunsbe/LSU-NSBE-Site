<?php
	function writeNav($page){
		...
		echo '<ul>';
		if ($page == "index"){
			echo '<li><a class="SELitem" id="home" href="../index">Home</a></li>';
		} else {
			echo '<li><a class="item" id="home" href="../index">Home</a></li>';
		
		}
		if ($page == "purpose"){
			echo '<li><a class="SELitem" id="purpose" href="../purpose">About NSBE</a></li>';
		} else {
			echo '<li><a class="item" id="purpose" href="../purpose">About NSBE</a></li>';
		}
